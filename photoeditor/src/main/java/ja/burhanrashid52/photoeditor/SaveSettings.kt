...
class SaveSettings private constructor(builder: Builder) {
    ...
    class Builder {
        ...
        @JvmField var disableHardware = true
        ...
        fun setDisableHardware(disableHardware: Boolean): Builder {
            this.disableHardware = disableHardware
            return this
        }
    ...
    init {
        ...
        disableHardware = builder.disableHardware
    }
}